...
const Services = () => {
  const [openSection, setOpenSection] = useState<null | "taxation" | "cfo">(
    null
  );
  return (
    <div>
        ...
        <div className="col-xl-12 col-lg-6 col-md-12 col-sm-12 about-section1-left text-center ">
          <div className="d-flex flex-column">
            ...
            <p className="about-section1-left-para mt-4">
              Simplify your tax processes and ensure full compliance with
              tailored accounting solutions. From tax planning and{" "}
              <p className="about-section1-left-para ">
                filing to GST, income tax, and advisory services — our
                experienced team is here to support individuals, businesses,
                <p className="about-section1-left-para ">
                  {" "}
      ...
      <div className="pt-5">
        <ServiceSection2
          isOpen={openSection === "taxation"}
          onToggle={() =>
            setOpenSection(openSection === "taxation" ? null : "taxation")
          }
        />
      </div>
      <div className="pt-5">
        {" "}
        <ServiceSection3
          isOpen={openSection === "cfo"}
          onToggle={() => setOpenSection(openSection === "cfo" ? null : "cfo")}
        />
      </div>
      <div className="pt-5">
        <ServiceSection4 />
